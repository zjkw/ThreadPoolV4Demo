...
void	CWrapCallWrap_TestCase::CallerRoutine(const task_id_t& self_id, const task_data_t& param)
{
...
void	CWrapCallWrap_TestCase::WorkRoutine(const task_id_t& self_id, const task_data_t& param)
{
